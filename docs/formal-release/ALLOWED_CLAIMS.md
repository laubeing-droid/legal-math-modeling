...
| The v2 registry contains 52 distinct types and preserves v1 names | `LegalModelV2.lean` and `theory/spec/canonical_v2/manifest.py` |

The machine-readable mirror of this table and the forbidden list is [claims_registry.json](claims_registry.json); a drift gate keeps the two in lockstep.
