...
Accordingly, downstream runtime adoption of LSC-derived metadata is spec-conformant only while it does not alter DecisionStatus, verified-fact gates, Horn closure, attack/exception/priority/permission semantics, checker acceptance, theorem statements, or formal release claims.
