...
structure OuterStep (S : Type) where
  step : Set S → Set S
...
theorem outer_two_step (T1 T2 : OuterStep S) (c0 c1 c2 : Set S)
...
coverage. -/
theorem outer_three_step (T1 T2 T3 : OuterStep S) (c0 c1 c2 c3 : Set S)
...
theorem pipeline_monotone (steps : List (OuterStep S)) (X Y : Set S) (hsub : X ⊆ Y) :
