...
# Technical Decision Document (Text Version): Legal Model System
...
This document is the plain-text version of the technical decision document. The canonical version is `gemini_decisions.md`. The content is identical.
